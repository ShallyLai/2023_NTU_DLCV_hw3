...
from utils.prefix_decoder import Decoder, Config
...
def main():
    ...
    for block in model.decoder.transformer.h:
        ...
        for param in block.attn.c_attn_pre.parameters(): # TODO prefix 
            param.require_grad = True
    for P in model.decoder.prefix.parameters():
        P.require_grad = True
    ...
    for epoch in range(epochs):
        ...
        torch.save(save_weights, f"./p2_results/p2_prefix/p2_{epoch + 1}_prefix.pth")
