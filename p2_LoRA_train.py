...
def main():
    ...
    #encoder_model = timm.create_model("vit_large_patch14_clip_336.laion2b_ft_in12k_in1k", pretrained = True, num_classes = 0) 
    #encoder_model = timm.create_model("vit_large_patch14_clip_224.openai_ft_in12k_in1k", pretrained = True, num_classes = 0)
    ...
    lora.mark_only_lora_as_trainable(model) # TODO LoRA freeze layers
    ...
    for epoch in range(epochs):
        ...
        torch.save(save_weights, f"./p2_results/p2_LoRA/p2_{epoch + 1}_LoRA_1.pth")
